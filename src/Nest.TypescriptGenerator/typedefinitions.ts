...
interface CatAliasesRequestParameters extends FluentRequestParameters<CatAliasesRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface FluentRequestParameters<T> {
	DefaultHttpMethod: HttpMethod;
}
interface CatAllocationRequestParameters extends FluentRequestParameters<CatAllocationRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatCountRequestParameters extends FluentRequestParameters<CatCountRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatFielddataRequestParameters extends FluentRequestParameters<CatFielddataRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatHealthRequestParameters extends FluentRequestParameters<CatHealthRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatIndicesRequestParameters extends FluentRequestParameters<CatIndicesRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatMasterRequestParameters extends FluentRequestParameters<CatMasterRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatNodesRequestParameters extends FluentRequestParameters<CatNodesRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatPendingTasksRequestParameters extends FluentRequestParameters<CatPendingTasksRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatPluginsRequestParameters extends FluentRequestParameters<CatPluginsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatRecoveryRequestParameters extends FluentRequestParameters<CatRecoveryRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatSegmentsRequestParameters extends FluentRequestParameters<CatSegmentsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatShardsRequestParameters extends FluentRequestParameters<CatShardsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatThreadPoolRequestParameters extends FluentRequestParameters<CatThreadPoolRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ClusterHealthRequestParameters extends FluentRequestParameters<ClusterHealthRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
...
interface ClusterPendingTasksRequestParameters extends FluentRequestParameters<ClusterPendingTasksRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ClusterRerouteRequestParameters extends FluentRequestParameters<ClusterRerouteRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ClusterGetSettingsRequestParameters extends FluentRequestParameters<ClusterGetSettingsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ClusterPutSettingsRequestParameters extends FluentRequestParameters<ClusterPutSettingsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ClusterStateRequestParameters extends FluentRequestParameters<ClusterStateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ClusterStatsRequestParameters extends FluentRequestParameters<ClusterStatsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface NodesHotThreadsRequestParameters extends FluentRequestParameters<NodesHotThreadsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface NodesInfoRequestParameters extends FluentRequestParameters<NodesInfoRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface NodesStatsRequestParameters extends FluentRequestParameters<NodesStatsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface PingRequestParameters extends FluentRequestParameters<PingRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface RootNodeInfoRequestParameters extends FluentRequestParameters<RootNodeInfoRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface BulkRequestParameters extends FluentRequestParameters<BulkRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteByQueryRequestParameters extends FluentRequestParameters<DeleteByQueryRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface MultiGetRequestParameters extends FluentRequestParameters<MultiGetRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface MultiTermVectorsRequestParameters extends FluentRequestParameters<MultiTermVectorsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteRequestParameters extends FluentRequestParameters<DeleteRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DocumentExistsRequestParameters extends FluentRequestParameters<DocumentExistsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetRequestParameters extends FluentRequestParameters<GetRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SourceRequestParameters extends FluentRequestParameters<SourceRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface BulkAliasRequestParameters extends FluentRequestParameters<BulkAliasRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface AliasExistsRequestParameters extends FluentRequestParameters<AliasExistsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteAliasRequestParameters extends FluentRequestParameters<DeleteAliasRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetAliasRequestParameters extends FluentRequestParameters<GetAliasRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetAliasesRequestParameters extends FluentRequestParameters<GetAliasesRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface PutAliasRequestParameters extends FluentRequestParameters<PutAliasRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface AnalyzeRequestParameters extends FluentRequestParameters<AnalyzeRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CreateIndexRequestParameters extends FluentRequestParameters<CreateIndexRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteIndexRequestParameters extends FluentRequestParameters<DeleteIndexRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetIndexRequestParameters extends FluentRequestParameters<GetIndexRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface IndexExistsRequestParameters extends FluentRequestParameters<IndexExistsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CloseIndexRequestParameters extends FluentRequestParameters<CloseIndexRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface OpenIndexRequestParameters extends FluentRequestParameters<OpenIndexRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface TypeExistsRequestParameters extends FluentRequestParameters<TypeExistsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetIndexSettingsRequestParameters extends FluentRequestParameters<GetIndexSettingsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteIndexTemplateRequestParameters extends FluentRequestParameters<DeleteIndexTemplateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetIndexTemplateRequestParameters extends FluentRequestParameters<GetIndexTemplateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface IndexTemplateExistsRequestParameters extends FluentRequestParameters<IndexTemplateExistsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface PutIndexTemplateRequestParameters extends FluentRequestParameters<PutIndexTemplateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface UpdateIndexSettingsRequestParameters extends FluentRequestParameters<UpdateIndexSettingsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetFieldMappingRequestParameters extends FluentRequestParameters<GetFieldMappingRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetMappingRequestParameters extends FluentRequestParameters<GetMappingRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface PutMappingRequestParameters extends FluentRequestParameters<PutMappingRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface RecoveryStatusRequestParameters extends FluentRequestParameters<RecoveryStatusRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SegmentsRequestParameters extends FluentRequestParameters<SegmentsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface IndicesStatsRequestParameters extends FluentRequestParameters<IndicesStatsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ClearCacheRequestParameters extends FluentRequestParameters<ClearCacheRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface FlushRequestParameters extends FluentRequestParameters<FlushRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface OptimizeRequestParameters extends FluentRequestParameters<OptimizeRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface RefreshRequestParameters extends FluentRequestParameters<RefreshRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SyncedFlushRequestParameters extends FluentRequestParameters<SyncedFlushRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface UpgradeRequestParameters extends FluentRequestParameters<UpgradeRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface UpgradeStatusRequestParameters extends FluentRequestParameters<UpgradeStatusRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteWarmerRequestParameters extends FluentRequestParameters<DeleteWarmerRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetWarmerRequestParameters extends FluentRequestParameters<GetWarmerRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface PutWarmerRequestParameters extends FluentRequestParameters<PutWarmerRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteScriptRequestParameters extends FluentRequestParameters<DeleteScriptRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetScriptRequestParameters extends FluentRequestParameters<GetScriptRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface PutScriptRequestParameters extends FluentRequestParameters<PutScriptRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CreateRepositoryRequestParameters extends FluentRequestParameters<CreateRepositoryRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteRepositoryRequestParameters extends FluentRequestParameters<DeleteRepositoryRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetRepositoryRequestParameters extends FluentRequestParameters<GetRepositoryRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface VerifyRepositoryRequestParameters extends FluentRequestParameters<VerifyRepositoryRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface RestoreRequestParameters extends FluentRequestParameters<RestoreRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteSnapshotRequestParameters extends FluentRequestParameters<DeleteSnapshotRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetSnapshotRequestParameters extends FluentRequestParameters<GetSnapshotRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SnapshotRequestParameters extends FluentRequestParameters<SnapshotRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SnapshotStatusRequestParameters extends FluentRequestParameters<SnapshotStatusRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CountRequestParameters extends FluentRequestParameters<CountRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface FieldStatsRequestParameters extends FluentRequestParameters<FieldStatsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface MultiSearchRequestParameters extends FluentRequestParameters<MultiSearchRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface MultiPercolateRequestParameters extends FluentRequestParameters<MultiPercolateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface IndexRequestParameters extends FluentRequestParameters<IndexRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ClearScrollRequestParameters extends FluentRequestParameters<ClearScrollRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ScrollRequestParameters extends FluentRequestParameters<ScrollRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SearchRequestParameters extends FluentRequestParameters<SearchRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SearchExistsRequestParameters extends FluentRequestParameters<SearchExistsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SearchShardsRequestParameters extends FluentRequestParameters<SearchShardsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SearchTemplateRequestParameters extends FluentRequestParameters<SearchTemplateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface DeleteSearchTemplateRequestParameters extends FluentRequestParameters<DeleteSearchTemplateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface GetSearchTemplateRequestParameters extends FluentRequestParameters<GetSearchTemplateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface PutSearchTemplateRequestParameters extends FluentRequestParameters<PutSearchTemplateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface SuggestRequestParameters extends FluentRequestParameters<SuggestRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface ValidateQueryRequestParameters extends FluentRequestParameters<ValidateQueryRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatHelpRequestParameters extends FluentRequestParameters<CatHelpRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface CatNodeattrsRequestParameters extends FluentRequestParameters<CatNodeattrsRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface IndicesShardStoresRequestParameters extends FluentRequestParameters<IndicesShardStoresRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
interface RenderSearchTemplateRequestParameters extends FluentRequestParameters<RenderSearchTemplateRequestParameters> {
	DefaultHttpMethod: HttpMethod;
}
...
interface Type extends MemberInfo {
...
interface Func<T1, T2, TResult> extends MulticastDelegate {
}
interface MulticastDelegate extends Delegate {
}
interface Delegate {
	Method: MethodInfo;
	Target: any;
...
interface ConstructorInfo extends MethodBase {
	MemberType: MemberTypes;
}
...
interface TypeInfo extends Type {
...
interface EventInfo extends MemberInfo {
	MemberType: MemberTypes;
...
interface StructLayoutAttribute extends Attribute {
	Value: LayoutKind;
}
