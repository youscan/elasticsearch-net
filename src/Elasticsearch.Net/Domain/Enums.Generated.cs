...
namespace Elasticsearch252.Net
{
    ...
    { 
		...
		public static string GetStringValue(this Consistency enumValue)
		{
			...
			throw new ArgumentException($"'{enumValue.ToString()}' is not a valid value for enum 'Consistency'");		
		}
		...
		public static string GetStringValue(this Feature enumValue)
		{
			...
			if ((enumValue & Feature.Warmers) != 0) list.Add("_warmers");
		...
		static KnownEnums()
		{
			EnumStringResolvers.TryAdd(typeof(Consistency), (e) => GetStringValue((Consistency)e));
