...
namespace Elasticsearch.Net
{
	...
	public partial class ElasticLowLevelClient : IElasticLowLevelClient
	{
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> CatTasksAsync<T>(Func<CatTasksRequestParameters, CatTasksRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(GET, Url($"_cat/tasks"), null, _params(requestParameters, contentType: "text/plain", accept: "text/plain"));
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> ClusterAllocationExplainGetAsync<T>(Func<ClusterAllocationExplainRequestParameters, ClusterAllocationExplainRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(GET, Url($"_cluster/allocation/explain"), null, _params(requestParameters));
		...
		///<param name="body">The index, shard, and primary flag to explain. Empty means &#39;explain the first unassigned shard&#39;</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> ClusterAllocationExplainAsync<T>(PostData<object> body, Func<ClusterAllocationExplainRequestParameters, ClusterAllocationExplainRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_cluster/allocation/explain"), body, _params(requestParameters));
		...
		public Task<ElasticsearchResponse<T>> DeleteByQueryAsync<T>(string index, PostData<object> body, Func<DeleteByQueryRequestParameters, DeleteByQueryRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"{index.NotNull("index")}/_delete_by_query"), body, _params(requestParameters));
		...
		public Task<ElasticsearchResponse<T>> DeleteByQueryAsync<T>(string index, string type, PostData<object> body, Func<DeleteByQueryRequestParameters, DeleteByQueryRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"{index.NotNull("index")}/{type.NotNull("type")}/_delete_by_query"), body, _params(requestParameters));
		...
		public Task<ElasticsearchResponse<T>> ReindexRethrottleAsync<T>(string task_id, Func<ReindexRethrottleRequestParameters, ReindexRethrottleRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_reindex/{task_id}/_rethrottle"), null, _params(requestParameters));
		...
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherAckWatch<T>(string watch_id, Func<XpackWatcherAckWatchRequestParameters, XpackWatcherAckWatchRequestParameters> requestParameters = null)
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherAckWatchAsync<T>(string watch_id, Func<XpackWatcherAckWatchRequestParameters, XpackWatcherAckWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/watch/{watch_id.NotNull("watch_id")}/_ack"), null, _params(requestParameters));
		...
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherAckWatch<T>(string watch_id, string action_id, Func<XpackWatcherAckWatchRequestParameters, XpackWatcherAckWatchRequestParameters> requestParameters = null)
		...
		///<param name="action_id">A comma-separated list of the action ids to be acked</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherAckWatchAsync<T>(string watch_id, string action_id, Func<XpackWatcherAckWatchRequestParameters, XpackWatcherAckWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/watch/{watch_id.NotNull("watch_id")}/_ack/{action_id.NotNull("action_id")}"), null, _params(requestParameters));
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherAckWatchPost<T>(string watch_id, Func<XpackWatcherAckWatchRequestParameters, XpackWatcherAckWatchRequestParameters> requestParameters = null)
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherAckWatchPostAsync<T>(string watch_id, Func<XpackWatcherAckWatchRequestParameters, XpackWatcherAckWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_xpack/watcher/watch/{watch_id.NotNull("watch_id")}/_ack"), null, _params(requestParameters));
		...
		///<param name="action_id">A comma-separated list of the action ids to be acked</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherAckWatchPost<T>(string watch_id, string action_id, Func<XpackWatcherAckWatchRequestParameters, XpackWatcherAckWatchRequestParameters> requestParameters = null)
		...
		///<param name="action_id">A comma-separated list of the action ids to be acked</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherAckWatchPostAsync<T>(string watch_id, string action_id, Func<XpackWatcherAckWatchRequestParameters, XpackWatcherAckWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_xpack/watcher/watch/{watch_id.NotNull("watch_id")}/_ack/{action_id.NotNull("action_id")}"), null, _params(requestParameters));
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherActivateWatchAsync<T>(string watch_id, Func<XpackWatcherActivateWatchRequestParameters, XpackWatcherActivateWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/watch/{watch_id.NotNull("watch_id")}/_activate"), null, _params(requestParameters));
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherActivateWatchPostAsync<T>(string watch_id, Func<XpackWatcherActivateWatchRequestParameters, XpackWatcherActivateWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_xpack/watcher/watch/{watch_id.NotNull("watch_id")}/_activate"), null, _params(requestParameters));
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherDeactivateWatch<T>(string watch_id, Func<XpackWatcherDeactivateWatchRequestParameters, XpackWatcherDeactivateWatchRequestParameters> requestParameters = null)
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherDeactivateWatchAsync<T>(string watch_id, Func<XpackWatcherDeactivateWatchRequestParameters, XpackWatcherDeactivateWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/watch/{watch_id.NotNull("watch_id")}/_deactivate"), null, _params(requestParameters));
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherDeactivateWatchPost<T>(string watch_id, Func<XpackWatcherDeactivateWatchRequestParameters, XpackWatcherDeactivateWatchRequestParameters> requestParameters = null)
		...
		///<param name="watch_id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherDeactivateWatchPostAsync<T>(string watch_id, Func<XpackWatcherDeactivateWatchRequestParameters, XpackWatcherDeactivateWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_xpack/watcher/watch/{watch_id.NotNull("watch_id")}/_deactivate"), null, _params(requestParameters));
		...
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherDeleteWatch<T>(string id, Func<XpackWatcherDeleteWatchRequestParameters, XpackWatcherDeleteWatchRequestParameters> requestParameters = null)
		...
		///<param name="id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherDeleteWatchAsync<T>(string id, Func<XpackWatcherDeleteWatchRequestParameters, XpackWatcherDeleteWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(DELETE, Url($"_xpack/watcher/watch/{id.NotNull("id")}"), null, _params(requestParameters));
		...
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherExecuteWatch<T>(string id, PostData<object> body, Func<XpackWatcherExecuteWatchRequestParameters, XpackWatcherExecuteWatchRequestParameters> requestParameters = null)
		...
		///<param name="body">Execution control</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherExecuteWatchAsync<T>(string id, PostData<object> body, Func<XpackWatcherExecuteWatchRequestParameters, XpackWatcherExecuteWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/watch/{id.NotNull("id")}/_execute"), body, _params(requestParameters));
		...
		///<param name="body">Execution control</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherExecuteWatch<T>(PostData<object> body, Func<XpackWatcherExecuteWatchRequestParameters, XpackWatcherExecuteWatchRequestParameters> requestParameters = null)
		...
		///<param name="body">Execution control</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherExecuteWatchAsync<T>(PostData<object> body, Func<XpackWatcherExecuteWatchRequestParameters, XpackWatcherExecuteWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/watch/_execute"), body, _params(requestParameters));
		...
		///<param name="body">Execution control</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherExecuteWatchPost<T>(string id, PostData<object> body, Func<XpackWatcherExecuteWatchRequestParameters, XpackWatcherExecuteWatchRequestParameters> requestParameters = null)
		...
		///<param name="body">Execution control</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherExecuteWatchPostAsync<T>(string id, PostData<object> body, Func<XpackWatcherExecuteWatchRequestParameters, XpackWatcherExecuteWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_xpack/watcher/watch/{id.NotNull("id")}/_execute"), body, _params(requestParameters));
		...
		///<param name="body">Execution control</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherExecuteWatchPost<T>(PostData<object> body, Func<XpackWatcherExecuteWatchRequestParameters, XpackWatcherExecuteWatchRequestParameters> requestParameters = null)
		...
		///<param name="body">Execution control</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherExecuteWatchPostAsync<T>(PostData<object> body, Func<XpackWatcherExecuteWatchRequestParameters, XpackWatcherExecuteWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_xpack/watcher/watch/_execute"), body, _params(requestParameters));
		...
		///<param name="id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherGetWatch<T>(string id, Func<XpackWatcherGetWatchRequestParameters, XpackWatcherGetWatchRequestParameters> requestParameters = null)
		...
		///<param name="id">Watch ID</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherGetWatchAsync<T>(string id, Func<XpackWatcherGetWatchRequestParameters, XpackWatcherGetWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(GET, Url($"_xpack/watcher/watch/{id.NotNull("id")}"), null, _params(requestParameters));
		...
		///<param name="body">The watch</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherPutWatchAsync<T>(string id, PostData<object> body, Func<XpackWatcherPutWatchRequestParameters, XpackWatcherPutWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/watch/{id.NotNull("id")}"), body, _params(requestParameters));
		...
		///<param name="body">The watch</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherPutWatchPostAsync<T>(string id, PostData<object> body, Func<XpackWatcherPutWatchRequestParameters, XpackWatcherPutWatchRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(POST, Url($"_xpack/watcher/watch/{id.NotNull("id")}"), body, _params(requestParameters));
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherRestart<T>(Func<XpackWatcherRestartRequestParameters, XpackWatcherRestartRequestParameters> requestParameters = null)
			where T : class => this.DoRequest<T>(PUT, Url($"_xpack/watcher/_restart"), null, _params(requestParameters));
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherRestartAsync<T>(Func<XpackWatcherRestartRequestParameters, XpackWatcherRestartRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/_restart"), null, _params(requestParameters));
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherStart<T>(Func<XpackWatcherStartRequestParameters, XpackWatcherStartRequestParameters> requestParameters = null)
			where T : class => this.DoRequest<T>(PUT, Url($"_xpack/watcher/_start"), null, _params(requestParameters));
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherStartAsync<T>(Func<XpackWatcherStartRequestParameters, XpackWatcherStartRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/_start"), null, _params(requestParameters));
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherStats<T>(Func<XpackWatcherStatsRequestParameters, XpackWatcherStatsRequestParameters> requestParameters = null)
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherStatsAsync<T>(Func<XpackWatcherStatsRequestParameters, XpackWatcherStatsRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(GET, Url($"_xpack/watcher/stats"), null, _params(requestParameters));
		...
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherStats<T>(string metric, Func<XpackWatcherStatsRequestParameters, XpackWatcherStatsRequestParameters> requestParameters = null)
			where T : class => this.DoRequest<T>(GET, Url($"_xpack/watcher/stats/{metric.NotNull("metric")}"), null, _params(requestParameters));
		...
		///<param name="metric">Controls what additional stat metrics should be include in the response</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherStatsAsync<T>(string metric, Func<XpackWatcherStatsRequestParameters, XpackWatcherStatsRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(GET, Url($"_xpack/watcher/stats/{metric.NotNull("metric")}"), null, _params(requestParameters));
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public ElasticsearchResponse<T> XpackWatcherStop<T>(Func<XpackWatcherStopRequestParameters, XpackWatcherStopRequestParameters> requestParameters = null)
			where T : class => this.DoRequest<T>(PUT, Url($"_xpack/watcher/_stop"), null, _params(requestParameters));
	    ...
	    ///</summary>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		public Task<ElasticsearchResponse<T>> XpackWatcherStopAsync<T>(Func<XpackWatcherStopRequestParameters, XpackWatcherStopRequestParameters> requestParameters = null)
			where T : class => this.DoRequestAsync<T>(PUT, Url($"_xpack/watcher/_stop"), null, _params(requestParameters));
