...
///<param name="id"> this parameter is required</param>
	...
	///<summary>descriptor for ReindexRethrottle <pre>https://www.elastic.co/guide/en/elasticsearch/reference/2.4/docs-reindex.html</pre></summary>
...
///<param name="username"> this parameter is required</param>
	...
	///<summary>descriptor for WatcherAckWatch <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-ack-watch.html</pre></summary>
...
///<param name="watch_id"> this parameter is required</param>
	...
	///<summary>descriptor for WatcherActivateWatch <pre>https://www.elastic.co/guide/en/watcher/current/api-rest.html#api-rest-activate-watch</pre></summary>
...
///<param name="watch_id"> this parameter is required</param>
	...
	///<summary>descriptor for WatcherDeactivateWatch <pre>https://www.elastic.co/guide/en/watcher/current/api-rest.html#api-rest-deactivate-watch</pre></summary>
...
///<param name="watch_id"> this parameter is required</param>
	...
	///<summary>descriptor for WatcherDeleteWatch <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-delete-watch.html</pre></summary>
...
///<param name="id"> this parameter is required</param>
		...
		public DeleteWatchDescriptor Force(bool force = true) => AssignParam(p=>p.Force(force));
	...
	///<summary>descriptor for WatcherExecuteWatch <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-execute-watch.html</pre></summary>
	...
	///<summary>descriptor for WatcherGetWatch <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-get-watch.html</pre></summary>
...
///<param name="id"> this parameter is required</param>
	...
	///<summary>descriptor for WatcherInfo <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-info.html</pre></summary>
	public partial class WatcherInfoDescriptor  : RequestDescriptorBase<WatcherInfoDescriptor,WatcherInfoRequestParameters, IWatcherInfoRequest>, IWatcherInfoRequest
	{ 
			
		///<summary>The URL-encoded request definition</summary>
		public WatcherInfoDescriptor Source(string source) => AssignParam(p=>p.Source(source));

		///<summary>Comma separated list of filters used to reduce the response returned by Elasticsearch</summary>
		public WatcherInfoDescriptor FilterPath(string filter_path) => AssignParam(p=>p.FilterPath(filter_path));
	
	}
	
	///<summary>descriptor for WatcherPutWatch <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-put-watch.html</pre></summary>
...
///<param name="id"> this parameter is required</param>
	...
	///<summary>descriptor for WatcherRestart <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-service.html</pre></summary>
	...
	///<summary>descriptor for WatcherStart <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-service.html</pre></summary>
	...
	///<summary>descriptor for WatcherStats <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-stats.html</pre></summary>
	...
	///<summary>descriptor for WatcherStop <pre>http://www.elastic.co/guide/en/watcher/current/appendix-api-service.html</pre></summary>
