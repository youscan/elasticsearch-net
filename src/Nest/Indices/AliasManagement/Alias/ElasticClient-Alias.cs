...
namespace Nest500
{
	public partial interface IElasticClient
	{
		...
		/// <inheritdoc/>
		Task<IBulkAliasResponse> AliasAsync(Func<BulkAliasDescriptor, IBulkAliasRequest> selector, CancellationToken cancellationToken = default(CancellationToken));
	...
	public partial class ElasticClient
	{
		...
		/// <inheritdoc/>
		public Task<IBulkAliasResponse> AliasAsync(Func<BulkAliasDescriptor, IBulkAliasRequest> selector, CancellationToken cancellationToken = default(CancellationToken))=>
			this.AliasAsync(selector?.Invoke(new BulkAliasDescriptor()), cancellationToken);
