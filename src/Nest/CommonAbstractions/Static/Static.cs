...
namespace Nest252
{
	public static class Infer
	{
		...
		public static Indices AllIndices = Nest252.Indices.All;
		...
		public static Id Id<T>(T document) where T : class => Nest252.Id.From(document);
		...
		public static Field Field<T>(Expression<Func<T, object>> path, double? boost = null)
			where T : class =>
			Nest252.Field.Create(path, boost);

		public static Field Field(string field, double? boost = null) => Nest252.Field.Create(field, boost);
