...
namespace Nest500
{
	...
	public partial class TermVectorsRequest<TDocument>
		where TDocument : class
	{
		Elasticsearch500.Net.HttpMethod IRequest.HttpMethod => (this.Document != null || this.Filter != null) ? Elasticsearch500.Net.HttpMethod.POST : Elasticsearch500.Net.HttpMethod.GET;
