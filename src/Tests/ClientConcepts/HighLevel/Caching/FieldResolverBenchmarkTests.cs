...
namespace Tests.ClientConcepts.HighLevel.Caching
{
	...
	public class FieldResolverBenchmarkTests : BenchmarkTestBase
	{
		...
		{
			return _nonCachingExpressionResolver.Resolve(Infer.Field<Project>(p => p.Name));
		}

		[Benchmark]
		public string CachedFieldUsingExpression()
		{
			return _expressionResolver.Resolve(Infer.Field<Project>(p => p.Name));
		}

		[Benchmark]
		public string NonCachedFieldUsingPropertyInfo()
		{
			Field field = typeof(Project).GetProperty(nameof(Project.Name));
			return _nonCachingPropertyResolver.Resolve(field);
		}
		...
		{
			Field field = typeof(Project).GetProperty(nameof(Project.Name));
			return _propertyResolver.Resolve(field);
		}
		...
		{
			Field field = "Name";
			return _nonCachingStringResolver.Resolve(field);
		}
		...
		{
			Field field = "Name";
			return _stringResolver.Resolve(field);
		}
	}
	...
	public class PropertyNameResolverBenchmarkTests : BenchmarkTestBase
	{
		...
		{
			return _nonCachingExpressionResolver.Resolve(Infer.Property<Project>(p => p.Name));
		}

		[Benchmark]
		public string CachedPropertyUsingExpression()
		{
			return _expressionResolver.Resolve(Infer.Property<Project>(p => p.Name));
		}

		[Benchmark]
		public string NonCachedPropertyUsingPropertyInfo()
		{
			PropertyName propertyName = typeof(Project).GetProperty(nameof(Project.Name));
			return _nonCachingPropertyResolver.Resolve(propertyName);
		}
		...
		{
			PropertyName propertyName = typeof(Project).GetProperty(nameof(Project.Name));
			return _propertyResolver.Resolve(propertyName);
		}
		...
		public string NonCachedPropertyUsingString()
		{
			...
			return _nonCachingStringResolver.Resolve(propertyName);
		}
		...
		{
			PropertyName propertyName = "Name";
			return _stringResolver.Resolve(propertyName);
		}
	}
}
