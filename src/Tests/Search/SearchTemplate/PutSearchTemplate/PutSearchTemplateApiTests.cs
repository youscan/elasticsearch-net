...
{
	public class PutSearchTemplateApiTests : ApiTestBase<ReadOnlyCluster, IPutSearchTemplateResponse, IPutSearchTemplateRequest, PutSearchTemplateDescriptor, PutSearchTemplateRequest>
	{
