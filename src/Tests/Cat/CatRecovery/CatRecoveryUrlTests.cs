	...
	public class CatRecoveryUrlTests : IUrlTests
	{
		[U] public async Task Urls()
		{
			...
			await GET("/_cat/recovery/project")
				...
				.Request(c => c.CatRecovery(new CatRecoveryRequest(Nest252.Indices.Index<Project>())))
				.FluentAsync(c => c.CatRecoveryAsync(r => r.Index<Project>()))
				.RequestAsync(c => c.CatRecoveryAsync(new CatRecoveryRequest(Nest252.Indices.Index<Project>())));
		}
	}
}
