	...
	public class CatShardsUrlTests : IUrlTests
	{
		[U] public async Task Urls()
		{
			...
			await GET("/_cat/shards/project")
				...
				.Request(c => c.CatShards(new CatShardsRequest(Nest252.Indices.Index<Project>())))
				.FluentAsync(c => c.CatShardsAsync(r => r.Index<Project>()))
				.RequestAsync(c => c.CatShardsAsync(new CatShardsRequest(Nest252.Indices.Index<Project>())));
		}
	}
}
